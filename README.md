...
```
`SUPERJOB_АПИ_КЛЮЧ` - это ключ для работы с API NASA. Получить этот токен можно на [api.superjob.ru](https://api.superjob.ru/) после регистрации с создания приложения. Ключ выглядит примерно так: `v3.r.134766023.f9e958907f57a85d61a4009d5s17f4f0c6dd63aa.93f096fd1c2e43a9b647fa3df71f52bbcc661e92`
